...
define('VIEW','179473700');
define('SERVICE_ACCOUNT','global-ticket-342019-49bc652192eb.json');
define('DOMAIN1','https://reeteshghimire.com.np');
define('DOMAIN2','http://localhost:8081/GOOGLE_ANALYTICS');
define('DOMAIN','https://horekkhobor.com/');
define('DOMAIN3','https://www.global-tickets.com/');
